...
savepath = 'Figures/GlasnevinNonLin'
...
# Model AR(6).
q_ma = 8
summary_ma, fittedvalues_ma, resid_ma, model_ma, aic_ma = lf.fit_arima_model(x=fd, p=0, q=q_ma, savepath=savepath,
                                                                             d=0, show=False)
...
maxtau = 31
lf.portmanteau_test(xV, maxtau, 0, 0, q_ma, savepath, show=True)
